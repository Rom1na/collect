...
import ar.gob.buenosaires.barelevamiento.openrosa.OpenRosaConstants;
...
import ar.gob.buenosaires.barelevamiento.test.MockedServerTest;
...
import static ar.gob.buenosaires.barelevamiento.test.TestUtils.assertMatches;
import static ar.gob.buenosaires.barelevamiento.test.TestUtils.cleanUpTempFiles;
import static ar.gob.buenosaires.barelevamiento.test.TestUtils.createTempFile;
import static ar.gob.buenosaires.barelevamiento.test.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTaskTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("ar.gob.buenosaires.barelevamiento/.* Dalvik/.*", r.getHeader("User-Agent"));
