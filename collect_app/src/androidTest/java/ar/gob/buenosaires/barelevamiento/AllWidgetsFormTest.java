...
import ar.gob.buenosaires.barelevamiento.test.FormActivityTestRule;
...
import ar.gob.buenosaires.barelevamiento.test.CustomMatchers;
...
public class AllWidgetsFormTest {
    ...
    public void testUrlWidget() {
        ...
        onView(ViewMatchers.withId(R.id.simple_button)).perform(click());
    ...
    public void testRangeIntegerWidget() {
        ...
        onVisibleSeekBar().check(matches(CustomMatchers.withProgress(randomValue)));
    ...
    private static class AllWidgetsFormTestRule extends FormActivityTestRule {
        ...
        AllWidgetsFormTestRule() {
            super(FormLoadingUtils.ALL_WIDGETS_FORM);
        }
    }
}
