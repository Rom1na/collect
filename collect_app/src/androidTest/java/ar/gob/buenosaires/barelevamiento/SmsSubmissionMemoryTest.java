...
import static ar.gob.buenosaires.barelevamiento.test.FormLoadingUtils.ALL_WIDGETS_FORM;
...
public class SmsSubmissionMemoryTest {
    @Rule
    public ActivityTestRule<FormEntryActivity> activityTestRule = FormLoadingUtils.getFormActivityTestRuleFor(FormLoadingUtils.ALL_WIDGETS_FORM);
