...
public class PrefMigrator {
    ...
    static final Migration[] MIGRATIONS = {
        translateKey("map_sdk_behavior").toKey(GeneralKeys.KEY_BASEMAP_SOURCE)
        ...
        translateKey("map_basemap_behavior").toKey(GeneralKeys.KEY_GOOGLE_MAP_STYLE)
        ...
        translateKey("map_basemap_behavior").toKey(GeneralKeys.KEY_MAPBOX_MAP_STYLE)
