...
public class FormMetadataMigrator {
    ...
    static final String[][] SOURCE_TARGET_VALUE_PAIRS = {
            {GeneralKeys.KEY_USERNAME,                  GeneralKeys.KEY_METADATA_USERNAME},
            {GeneralKeys.KEY_SELECTED_GOOGLE_ACCOUNT,   GeneralKeys.KEY_METADATA_EMAIL}
    };
    ...
    public static void migrate(SharedPreferences sharedPreferences) {
        boolean migrationAlreadyDone = sharedPreferences.getBoolean(GeneralKeys.KEY_METADATA_MIGRATED, false);
        ...
        if (!migrationAlreadyDone) {
            ...
            editor.putBoolean(GeneralKeys.KEY_METADATA_MIGRATED, true);
            editor.commit();
        }
    }
}
