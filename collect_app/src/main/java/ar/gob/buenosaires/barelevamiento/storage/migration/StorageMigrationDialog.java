...
import ar.gob.buenosaires.barelevamiento.activities.WebViewActivity;
import ar.gob.buenosaires.barelevamiento.injection.DaggerUtils;
import ar.gob.buenosaires.barelevamiento.material.MaterialFullScreenDialogFragment;
...
import ar.gob.buenosaires.barelevamiento.utilities.CustomTabHelper;
        ...
        migrateButton.setOnClickListener(v -> {
            if (MultiClickGuard.allowClick(getClass().getName())) {
                if (adminPasswordProvider.isAdminPasswordSet()) {
                    ...
                    args.putSerializable(AdminPasswordDialogFragment.ARG_ACTION, AdminPasswordDialogFragment.Action.STORAGE_MIGRATION);
