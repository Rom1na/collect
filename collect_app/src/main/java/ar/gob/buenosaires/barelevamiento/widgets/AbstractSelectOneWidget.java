...
import ar.gob.buenosaires.barelevamiento.adapters.SelectOneListAdapter;
...
public abstract class AbstractSelectOneWidget extends SelectTextWidget implements MultiChoiceWidget {
    ...
    protected void createLayout() {
        adapter = new SelectOneListAdapter(items, selectedValue, this, numColumns, this.getFormEntryPrompt(), this.getReferenceManager(), this.getAnswerFontSize(), this.getAudioHelper(), FormMediaUtils.getPlayColor(getFormEntryPrompt(), themeUtils), this.getContext(), autoAdvance);
