...
import static ar.gob.buenosaires.barelevamiento.utilities.ViewUtils.pxFromDp;
...
public abstract class SelectTextWidget extends SelectWidget {
    ...
    protected void setUpSearchBox(Context context) {
        ...
        params.setMargins(ViewUtils.pxFromDp(context, WidgetViewUtils.getStandardMargin(context)), 5,
                ViewUtils.pxFromDp(context, WidgetViewUtils.getStandardMargin(context)), 5);
