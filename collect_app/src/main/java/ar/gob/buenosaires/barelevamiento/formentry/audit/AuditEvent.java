...
import ar.gob.buenosaires.barelevamiento.utilities.CSVUtils;

import static ar.gob.buenosaires.barelevamiento.utilities.CSVUtils.getEscapedValueForCsv;
...
public class AuditEvent {
    ...
    public boolean recordValueChange(String newValue) {
        ...
        if (oldValue.contains(",") || oldValue.contains("\n")) {
            oldValue = CSVUtils.getEscapedValueForCsv(oldValue);
        }
