...
public class UrlWidget extends QuestionWidget implements ButtonWidget {
    ...
    public UrlWidget(Context context, QuestionDetails questionDetails) {
        ...
        openUrlButton = WidgetViewUtils.createSimpleButton(getContext(), getFormEntryPrompt().isReadOnly(), context.getString(R.string.open_url), getAnswerFontSize(), this);

        stringAnswer = WidgetViewUtils.getCenteredAnswerTextView(getContext(), getAnswerFontSize());
