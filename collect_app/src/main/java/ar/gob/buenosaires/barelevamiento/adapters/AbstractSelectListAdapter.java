...
import ar.gob.buenosaires.barelevamiento.widgets.SelectWidget;
...
import static ar.gob.buenosaires.barelevamiento.widgets.QuestionWidget.isRTL;
...
public abstract class AbstractSelectListAdapter extends RecyclerView.Adapter<AbstractSelectListAdapter.ViewHolder>
    ...
    abstract class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void addMediaFromChoice(AudioVideoImageTextLabel audioVideoImageTextLabel, int index, TextView textView, List<SelectChoice> items) {
            ...
            audioVideoImageTextLabel.setTag(FormMediaUtils.getClipID(getFormEntryPrompt(), item));
            ...
            String audioURI = FormMediaUtils.getPlayableAudioURI(getFormEntryPrompt(), item, getReferenceManager());
            if (audioURI != null) {
