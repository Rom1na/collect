...
import static ar.gob.buenosaires.barelevamiento.preferences.AdminPreferencesFragment.ADMIN_PREFERENCES;
...
public class AdminSharedPreferences {
    ...
    public AdminSharedPreferences(Context context) {
        sharedPreferences = context.getSharedPreferences(AdminPreferencesFragment.ADMIN_PREFERENCES, 0);
    }
