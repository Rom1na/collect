...
import ar.gob.buenosaires.barelevamiento.activities.GeoPointActivity;
...
import ar.gob.buenosaires.barelevamiento.widgets.utilities.GeoWidgetUtils;
...
import static ar.gob.buenosaires.barelevamiento.utilities.WidgetAppearanceUtils.MAPS;
import static ar.gob.buenosaires.barelevamiento.utilities.WidgetAppearanceUtils.PLACEMENT_MAP;
import static ar.gob.buenosaires.barelevamiento.utilities.WidgetAppearanceUtils.hasAppearance;
...
public class GeoPointWidget extends BaseGeoWidget {
    ...
    private void determineMapProperties() {
        ...
        if (MapProvider.getConfigurator().isAvailable(getContext())) {
            if (WidgetAppearanceUtils.hasAppearance(getFormEntryPrompt(), WidgetAppearanceUtils.PLACEMENT_MAP)) {
                draggable = true;
                useMap = true;
            } else if (WidgetAppearanceUtils.hasAppearance(getFormEntryPrompt(), WidgetAppearanceUtils.MAPS)) {
                draggable = false;
                useMap = true;
            }
        }
