...
public class GeneralSharedPreferences {
    ...
    public Object get(String key) {
        ...
        try {
            defaultValue = GeneralKeys.DEFAULTS.get(key);
        } catch (Exception e) {
    ...
    public GeneralSharedPreferences save(String key, @Nullable Object value) {
        ...
        if (value == null || value instanceof String) {
            if (key.equals(GeneralKeys.KEY_PERIODIC_FORM_UPDATES_CHECK) && get(GeneralKeys.KEY_PERIODIC_FORM_UPDATES_CHECK) != value) {
