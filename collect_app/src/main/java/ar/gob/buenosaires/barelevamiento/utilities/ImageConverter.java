...
import static ar.gob.buenosaires.barelevamiento.utilities.ApplicationConstants.Namespaces.XML_OPENROSA_NAMESPACE;
...
public class ImageConverter {
    ...
    private static Integer getMaxPixelsFromSettings(Context context) {
        Integer maxPixels = null;
        String imageSizeMode = (String) GeneralSharedPreferences.getInstance().get(GeneralKeys.KEY_IMAGE_SIZE);
