...
import ar.gob.buenosaires.barelevamiento.listeners.ActionListener;
...
import static ar.gob.buenosaires.barelevamiento.preferences.AdminKeys.ALL_KEYS;
import static ar.gob.buenosaires.barelevamiento.preferences.AdminKeys.KEY_ADMIN_PW;
import static ar.gob.buenosaires.barelevamiento.preferences.GeneralKeys.DEFAULTS;
import static ar.gob.buenosaires.barelevamiento.preferences.GeneralKeys.KEY_SERVER_URL;
...
public class PreferenceSaver {
    ...
    public void fromJSON(String content, @Nullable ActionListener listener) {
        try {
            ...
            if (!(new PreferenceValidator(GeneralKeys.DEFAULTS).isValid(generalPrefs))) {
                if (listener != null) {
    ...
    private static Collection<String> getAllGeneralKeys() {
        return new HashSet<>(GeneralKeys.DEFAULTS.keySet());
    }
