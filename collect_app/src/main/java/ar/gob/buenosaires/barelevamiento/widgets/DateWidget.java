...
import ar.gob.buenosaires.barelevamiento.fragments.dialogs.BikramSambatDatePickerDialog;
import ar.gob.buenosaires.barelevamiento.fragments.dialogs.CopticDatePickerDialog;
import ar.gob.buenosaires.barelevamiento.fragments.dialogs.CustomDatePickerDialog;
import ar.gob.buenosaires.barelevamiento.fragments.dialogs.EthiopianDatePickerDialog;
import ar.gob.buenosaires.barelevamiento.fragments.dialogs.IslamicDatePickerDialog;
import ar.gob.buenosaires.barelevamiento.fragments.dialogs.MyanmarDatePickerDialog;
import ar.gob.buenosaires.barelevamiento.fragments.dialogs.PersianDatePickerDialog;
import ar.gob.buenosaires.barelevamiento.logic.DatePickerDetails;
import ar.gob.buenosaires.barelevamiento.utilities.DateTimeUtils;
...
public class DateWidget extends QuestionWidget implements DatePickerDialog.OnDateSetListener, BinaryWidget {
    ...
    protected void createWidget(Context context) {
        ...
        dateButton = WidgetViewUtils.createSimpleButton(getContext(), getFormEntryPrompt().isReadOnly(), getContext().getString(R.string.select_date), getAnswerFontSize(), this);
        dateTextView = WidgetViewUtils.createAnswerTextView(getContext(), getAnswerFontSize());
        addViews(context);
    ...
    protected void showDatePickerDialog() {
        switch (datePickerDetails.getDatePickerType()) {
            case ETHIOPIAN:
                ...
                dialog.show(((FormEntryActivity) getContext()).getSupportFragmentManager(), CustomDatePickerDialog.DATE_PICKER_DIALOG);
                break;
            case COPTIC:
