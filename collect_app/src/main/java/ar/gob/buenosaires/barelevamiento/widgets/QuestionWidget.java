...
import ar.gob.buenosaires.barelevamiento.formentry.QuestionTextSizeHelper;
...
import ar.gob.buenosaires.barelevamiento.preferences.GuidanceHint;
import ar.gob.buenosaires.barelevamiento.utilities.AnimationUtils;
import ar.gob.buenosaires.barelevamiento.utilities.FormEntryPromptUtils;
...
import ar.gob.buenosaires.barelevamiento.utilities.StringUtils;
import ar.gob.buenosaires.barelevamiento.utilities.ThemeUtils;
import ar.gob.buenosaires.barelevamiento.utilities.ViewUtils;
import ar.gob.buenosaires.barelevamiento.widgets.interfaces.Widget;
...
import ar.gob.buenosaires.barelevamiento.formentry.QuestionTextSizeHelper;
import ar.gob.buenosaires.barelevamiento.formentry.media.AudioHelperFactory;
import ar.gob.buenosaires.barelevamiento.formentry.media.FormMediaUtils;
import ar.gob.buenosaires.barelevamiento.formentry.questions.AudioVideoImageTextLabel;
import ar.gob.buenosaires.barelevamiento.formentry.questions.QuestionDetails;
...
import static ar.gob.buenosaires.barelevamiento.analytics.AnalyticsEvents.AUDIO_QUESTION;
import static ar.gob.buenosaires.barelevamiento.formentry.media.FormMediaUtils.getClipID;
import static ar.gob.buenosaires.barelevamiento.formentry.media.FormMediaUtils.getPlayColor;
import static ar.gob.buenosaires.barelevamiento.formentry.media.FormMediaUtils.getPlayableAudioURI;
import static ar.gob.buenosaires.barelevamiento.injection.DaggerUtils.getComponent;
...
public abstract class QuestionWidget
    ...
    private void setupQuestionLabel(AudioVideoImageTextLabel label, FormEntryPrompt prompt) {
        ...
        if (playableAudioURI != null) {
            ...
            analytics.logEvent(AnalyticsEvents.AUDIO_QUESTION, "AudioLabel", questionDetails.getFormAnalyticsID());
        }
