...
package ar.gob.buenosaires.barelevamiento.activities;
...
import ar.gob.buenosaires.barelevamiento.dao.helpers.FormsDaoHelper;
import ar.gob.buenosaires.barelevamiento.dao.helpers.InstancesDaoHelper;
import ar.gob.buenosaires.barelevamiento.events.ReadPhoneStatePermissionRxEvent;
import ar.gob.buenosaires.barelevamiento.events.RxEventBus;
import ar.gob.buenosaires.barelevamiento.exception.JavaRosaException;
import ar.gob.buenosaires.barelevamiento.external.ExternalDataManager;
import ar.gob.buenosaires.barelevamiento.formentry.FormLoadingDialogFragment;
import ar.gob.buenosaires.barelevamiento.formentry.ODKView;
import ar.gob.buenosaires.barelevamiento.formentry.QuitFormDialog;
import ar.gob.buenosaires.barelevamiento.formentry.SaveFormProgressDialogFragment;
import ar.gob.buenosaires.barelevamiento.formentry.audit.AuditEvent;
import ar.gob.buenosaires.barelevamiento.formentry.audit.AuditUtils;
import ar.gob.buenosaires.barelevamiento.formentry.audit.ChangesReasonPromptDialogFragment;
import ar.gob.buenosaires.barelevamiento.formentry.audit.IdentifyUserPromptDialogFragment;
import ar.gob.buenosaires.barelevamiento.formentry.audit.IdentityPromptViewModel;
import ar.gob.buenosaires.barelevamiento.formentry.backgroundlocation.BackgroundLocationHelper;
import ar.gob.buenosaires.barelevamiento.formentry.backgroundlocation.BackgroundLocationManager;
import ar.gob.buenosaires.barelevamiento.formentry.backgroundlocation.BackgroundLocationViewModel;
import ar.gob.buenosaires.barelevamiento.formentry.repeats.AddRepeatDialog;
import ar.gob.buenosaires.barelevamiento.formentry.saving.FormSaveViewModel;
import ar.gob.buenosaires.barelevamiento.fragments.MediaLoadingFragment;
import ar.gob.buenosaires.barelevamiento.fragments.dialogs.CustomDatePickerDialog;
import ar.gob.buenosaires.barelevamiento.fragments.dialogs.LocationProvidersDisabledDialog;
import ar.gob.buenosaires.barelevamiento.fragments.dialogs.NumberPickerDialog;
...
import ar.gob.buenosaires.barelevamiento.listeners.AdvanceToNextListener;
import ar.gob.buenosaires.barelevamiento.listeners.FormLoaderListener;
import ar.gob.buenosaires.barelevamiento.listeners.PermissionListener;
import ar.gob.buenosaires.barelevamiento.listeners.SavePointListener;
import ar.gob.buenosaires.barelevamiento.listeners.WidgetValueChangedListener;
import ar.gob.buenosaires.barelevamiento.location.client.GoogleLocationClient;
import ar.gob.buenosaires.barelevamiento.logic.FormController;
import ar.gob.buenosaires.barelevamiento.logic.FormInfo;
import ar.gob.buenosaires.barelevamiento.logic.ImmutableDisplayableQuestion;
...
import ar.gob.buenosaires.barelevamiento.preferences.PreferencesActivity;
import ar.gob.buenosaires.barelevamiento.provider.FormsProviderAPI.FormsColumns;
import ar.gob.buenosaires.barelevamiento.provider.InstanceProviderAPI.InstanceColumns;
import ar.gob.buenosaires.barelevamiento.storage.StorageInitializer;
...
import ar.gob.buenosaires.barelevamiento.tasks.FormLoaderTask;
import ar.gob.buenosaires.barelevamiento.tasks.SaveFormIndexTask;
import ar.gob.buenosaires.barelevamiento.tasks.SaveFormToDisk;
import ar.gob.buenosaires.barelevamiento.tasks.SavePointTask;
...
import ar.gob.buenosaires.barelevamiento.utilities.DestroyableLifecyleOwner;
...
import ar.gob.buenosaires.barelevamiento.utilities.FormNameUtils;
import ar.gob.buenosaires.barelevamiento.utilities.ImageConverter;
import ar.gob.buenosaires.barelevamiento.utilities.MediaManager;
...
import ar.gob.buenosaires.barelevamiento.utilities.SnackbarUtils;
import ar.gob.buenosaires.barelevamiento.utilities.SoftKeyboardUtils;
import ar.gob.buenosaires.barelevamiento.utilities.ToastUtils;
import ar.gob.buenosaires.barelevamiento.widgets.DateTimeWidget;
import ar.gob.buenosaires.barelevamiento.widgets.QuestionWidget;
import ar.gob.buenosaires.barelevamiento.widgets.RangeWidget;
...
import static ar.gob.buenosaires.barelevamiento.analytics.AnalyticsEvents.LAUNCH_FORM_WITH_BG_LOCATION;
import static ar.gob.buenosaires.barelevamiento.analytics.AnalyticsEvents.SAVE_INCOMPLETE;
import static ar.gob.buenosaires.barelevamiento.utilities.AnimationUtils.areAnimationsEnabled;
import static ar.gob.buenosaires.barelevamiento.utilities.ApplicationConstants.RequestCodes;
import static ar.gob.buenosaires.barelevamiento.utilities.DialogUtils.getDialog;
import static ar.gob.buenosaires.barelevamiento.utilities.DialogUtils.showIfNotShowing;
import static ar.gob.buenosaires.barelevamiento.utilities.PermissionUtils.areStoragePermissionsGranted;
import static ar.gob.buenosaires.barelevamiento.utilities.PermissionUtils.finishAllActivities;
import static ar.gob.buenosaires.barelevamiento.utilities.ToastUtils.showLongToast;
import static ar.gob.buenosaires.barelevamiento.utilities.ToastUtils.showShortToast;
...
public class FormEntryActivity extends CollectAbstractActivity implements AnimationListener,
    ...
    private void loadForm() {
        allowMovingBackwards = (boolean) AdminSharedPreferences.getInstance().get(AdminKeys.KEY_MOVING_BACKWARDS);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (getFormController() != null && getFormController().currentFormCollectsBackgroundLocation()
            ...
            backgroundLocation.setChecked(GeneralSharedPreferences.getInstance().getBoolean(GeneralKeys.KEY_BACKGROUND_LOCATION, true));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.track_location:
                GeneralSharedPreferences.getInstance().save(GeneralKeys.KEY_BACKGROUND_LOCATION, !GeneralSharedPreferences.getInstance().getBoolean(GeneralKeys.KEY_BACKGROUND_LOCATION, true));
