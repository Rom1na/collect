...
import ar.gob.buenosaires.barelevamiento.listeners.OnBackPressedListener;
...
import ar.gob.buenosaires.barelevamiento.preferences.filters.ControlCharacterFilter;
import ar.gob.buenosaires.barelevamiento.preferences.filters.WhitespaceFilter;
import ar.gob.buenosaires.barelevamiento.preferences.utilities.ChangingServerUrlUtils;
...
import static ar.gob.buenosaires.barelevamiento.analytics.AnalyticsEvents.SET_CUSTOM_ENDPOINT;
import static ar.gob.buenosaires.barelevamiento.analytics.AnalyticsEvents.SET_FALLBACK_SHEETS_URL;
import static ar.gob.buenosaires.barelevamiento.analytics.AnalyticsEvents.SET_SERVER;
import static ar.gob.buenosaires.barelevamiento.preferences.GeneralKeys.KEY_FORMLIST_URL;
import static ar.gob.buenosaires.barelevamiento.preferences.GeneralKeys.KEY_PROTOCOL;
import static ar.gob.buenosaires.barelevamiento.preferences.GeneralKeys.KEY_SELECTED_GOOGLE_ACCOUNT;
import static ar.gob.buenosaires.barelevamiento.preferences.GeneralKeys.KEY_SMS_GATEWAY;
import static ar.gob.buenosaires.barelevamiento.preferences.GeneralKeys.KEY_SMS_PREFERENCE;
import static ar.gob.buenosaires.barelevamiento.preferences.GeneralKeys.KEY_SUBMISSION_URL;
import static ar.gob.buenosaires.barelevamiento.preferences.GeneralKeys.KEY_TRANSPORT_PREFERENCE;
import static ar.gob.buenosaires.barelevamiento.utilities.DialogUtils.showDialog;
...
public class ServerPreferencesFragment extends BasePreferenceFragment implements
    ...
    */
    ...
    public void addGooglePreferences() {
        ...
        selectedGoogleAccountPreference = findPreference(GeneralKeys.KEY_SELECTED_GOOGLE_ACCOUNT);
    ...
    public void addOtherPreferences() {
        ...
        formListUrlPreference = (EditTextPreference) findPreference(GeneralKeys.KEY_FORMLIST_URL);
        submissionUrlPreference = (EditTextPreference) findPreference(GeneralKeys.KEY_SUBMISSION_URL);
    ...
    private Preference.OnPreferenceChangeListener createChangeListener() {
        return (preference, newValue) -> {
            switch (preference.getKey()) {
                ...
                case GeneralKeys.KEY_SMS_GATEWAY:
                    ...
                    break;
                case GeneralKeys.KEY_FORMLIST_URL:
                case GeneralKeys.KEY_SUBMISSION_URL:
                    preference.setSummary(newValue.toString());
    ...
    protected void setDefaultAggregatePaths() {
        ...
        sharedPreferences.reset(GeneralKeys.KEY_FORMLIST_URL);
        sharedPreferences.reset(GeneralKeys.KEY_SUBMISSION_URL);
    }
    ...
    */
    ...
    private void runGoogleAccountValidation() {
        String account = (String) GeneralSharedPreferences.getInstance().get(GeneralKeys.KEY_SELECTED_GOOGLE_ACCOUNT);
        String protocol = (String) GeneralSharedPreferences.getInstance().get(GeneralKeys.KEY_PROTOCOL);
