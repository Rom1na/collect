...
import ar.gob.buenosaires.barelevamiento.adapters.AbstractSelectListAdapter;
    ...
    private void logAnalytics(QuestionDetails questionDetails) {
        if (items != null) {
            for (SelectChoice choice : items) {
                ...
                if (audioURI != null) {
                    analytics.logEvent(AnalyticsEvents.AUDIO_QUESTION, "AudioChoice", questionDetails.getFormAnalyticsID());
                    break;
                }
            }
        }
