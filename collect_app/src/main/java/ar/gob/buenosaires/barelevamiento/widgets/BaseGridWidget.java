...
import ar.gob.buenosaires.barelevamiento.external.ExternalSelectChoice;
...
import ar.gob.buenosaires.barelevamiento.utilities.ScreenUtils;
import ar.gob.buenosaires.barelevamiento.utilities.WidgetAppearanceUtils;
import ar.gob.buenosaires.barelevamiento.views.ExpandedHeightGridView;
import ar.gob.buenosaires.barelevamiento.widgets.interfaces.MultiChoiceWidget;
    ...
    private void logAnalytics(QuestionDetails questionDetails) {
        for (SelectChoice choice : items) {
            if (noButtonsMode) {
                ...
                if (audioURI != null) {
                    analytics.logEvent(AnalyticsEvents.AUDIO_QUESTION, "AudioChoiceGrid", questionDetails.getFormAnalyticsID());
                    break;
                }
            }
        }
