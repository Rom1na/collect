...
import ar.gob.buenosaires.barelevamiento.activities.viewmodels.FormMapViewModel;
import ar.gob.buenosaires.barelevamiento.dao.FormsDao;
import ar.gob.buenosaires.barelevamiento.forms.Form;
import ar.gob.buenosaires.barelevamiento.geo.MapFragment;
import ar.gob.buenosaires.barelevamiento.geo.MapPoint;
...
import ar.gob.buenosaires.barelevamiento.preferences.MapsPreferences;
...
public class FormMapActivity extends BaseGeoMapActivity {
    ...
    public void onFeatureClicked(int featureId) {
        FormMapViewModel.MappableFormInstance instance = instancesByFeatureId.get(featureId);
        FormMapViewModel.ClickAction clickAction = instance == null ? FormMapViewModel.ClickAction.NONE : instance.getClickAction();
