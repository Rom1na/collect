...
import static ar.gob.buenosaires.barelevamiento.utilities.NotificationUtils.CHANNEL_ID;

public class SmsNotificationReceiver extends BroadcastReceiver {
    public static final String SMS_NOTIFICATION_ACTION = "ar.gob.buenosaires.barelevamiento.COLLECT_SMS_NOTIFICATION_ACTION";
    private static final String SMS_NOTIFICATION_GROUP = "ar.gob.buenosaires.barelevamiento.COLLECT_SMS_NOTIFICATION_GROUP";
