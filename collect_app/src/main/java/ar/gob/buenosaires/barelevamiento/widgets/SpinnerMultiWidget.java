...
import ar.gob.buenosaires.barelevamiento.widgets.interfaces.ButtonWidget;
...
public class SpinnerMultiWidget extends ItemsWidget implements ButtonWidget, MultiChoiceWidget {
    ...
    public SpinnerMultiWidget(final Context context, QuestionDetails questionDetails) {
        ...
        button = WidgetViewUtils.createSimpleButton(getContext(), getFormEntryPrompt().isReadOnly(), context.getString(R.string.select_answer), getAnswerFontSize(), this);
        ...
        selectionText = WidgetViewUtils.createAnswerTextView(getContext(), getAnswerFontSize());
