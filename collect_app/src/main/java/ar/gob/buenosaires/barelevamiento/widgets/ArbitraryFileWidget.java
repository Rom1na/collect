...
public class ArbitraryFileWidget extends QuestionWidget implements FileWidget {
    ...
    private void setUpLayout(Context context) {
        ...
        chooseFileButton = WidgetViewUtils.createSimpleButton(getContext(), getFormEntryPrompt().isReadOnly(), getContext().getString(R.string.choose_file), getAnswerFontSize(), this);
        ...
        chosenFileNameTextView = WidgetViewUtils.createAnswerTextView(getContext(), binaryName, getAnswerFontSize());
