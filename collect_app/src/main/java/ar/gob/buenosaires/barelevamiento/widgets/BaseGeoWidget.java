...
import ar.gob.buenosaires.barelevamiento.widgets.interfaces.GeoWidget;
...
public abstract class BaseGeoWidget extends QuestionWidget implements GeoWidget {
    ...
    public BaseGeoWidget(Context context, QuestionDetails questionDetails) {
        ...
        answerDisplay = WidgetViewUtils.getCenteredAnswerTextView(getContext(), getAnswerFontSize());
