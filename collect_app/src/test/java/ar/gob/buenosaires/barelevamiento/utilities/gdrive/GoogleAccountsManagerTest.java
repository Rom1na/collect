package ar.gob.buenosaires.barelevamiento.utilities.gdrive;
...
public class GoogleAccountsManagerTest {
    ...
    @Before
    public void setup() {
        googleAccountsManager = Mockito.spy(new GoogleAccountsManager(mockedCredential, mockPreferences, mockIntent, mockThemeUtils));
