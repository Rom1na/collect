...
public class StorageMigratorTest {
    ...
    public void setup() {
        ...
        storageMigrator = Mockito.spy(new StorageMigrator(storagePathProvider, storageStateProvider, storageEraser, storageMigrationRepository, generalSharedPreferences, referenceManager, backgroundWorkManager, analytics));
