...
import ar.gob.buenosaires.barelevamiento.support.FakeLifecycleOwner;
import ar.gob.buenosaires.barelevamiento.support.FakeScheduler;
import ar.gob.buenosaires.barelevamiento.support.RobolectricHelpers;
import ar.gob.buenosaires.barelevamiento.support.SwipableParentActivity;
...
import static ar.gob.buenosaires.barelevamiento.support.RobolectricHelpers.setupMediaPlayerDataSource;
...
public class AudioControllerViewIntegrationTest {
    ...
    public void canPlayAndPauseAudio() throws Exception {
        ...
        MatcherAssert.assertThat(RobolectricHelpers.getCreatedFromResId(playButton), equalTo(R.drawable.ic_play_arrow_24dp));

        playButton.performClick();

        assertThat(mediaPlayer.isPlaying(), equalTo(true));
        assertThat(shadowOf(mediaPlayer).getDataSource(), equalTo(dataSource));
        MatcherAssert.assertThat(RobolectricHelpers.getCreatedFromResId(playButton), equalTo(R.drawable.ic_pause_24dp));
    ...
    public void resetsBackToBeginningWhenPlaybackFinishes() throws Exception {
        ...
        MatcherAssert.assertThat(RobolectricHelpers.getCreatedFromResId(view.findViewById(R.id.playBtn)), equalTo(R.drawable.ic_play_arrow_24dp));
    ...
    private AudioControllerView createAndSetupView(String clipID, int fileLength) throws IOException {
        String testFile = File.createTempFile("audio", ".mp3").getAbsolutePath();
        RobolectricHelpers.setupMediaPlayerDataSource(testFile, fileLength);
