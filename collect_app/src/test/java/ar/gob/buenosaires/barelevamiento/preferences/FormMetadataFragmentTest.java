...
public class FormMetadataFragmentTest {
    ...
    public void recreating_whenPermissionsAcceptedPreviously_showsPermissionDependantPreferences() {
        ...
        scenario.onFragment(fragment -> {
            assertThat(fragment.findPreference(PropertyManager.PROPMGR_SIM_SERIAL).getSummary(), equalTo("simSerial"));
        });
    ...
    public void whenDeviceDetailsAreMissing_preferenceSummariesAreNotSet() {
        ...
        scenario.onFragment(fragment -> {
            ...
            assertThat(fragment.findPreference(PropertyManager.PROPMGR_SIM_SERIAL).getSummary(), equalTo(notSetMessage));
            assertThat(fragment.findPreference(KEY_METADATA_PHONENUMBER).getSummary(), equalTo(notSetMessage));
            assertThat(fragment.findPreference(PropertyManager.PROPMGR_SUBSCRIBER_ID).getSummary(), equalTo(notSetMessage));
