...
import ar.gob.buenosaires.barelevamiento.geo.TestMapFragment;
import ar.gob.buenosaires.barelevamiento.injection.config.AppDependencyModule;
import ar.gob.buenosaires.barelevamiento.instances.TestInstancesRepository;
...
import static ar.gob.buenosaires.barelevamiento.activities.FormMapViewModelTest.testInstances;
...
public class FormMapActivityTest {
    ...
    @Before public void setUpActivity() {
        ...
        TestInstancesRepository testInstancesRepository = new TestInstancesRepository(Arrays.asList(FormMapViewModelTest.testInstances));
