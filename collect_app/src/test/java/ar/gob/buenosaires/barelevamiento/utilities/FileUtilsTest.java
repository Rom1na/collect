...
public class FileUtilsTest {
    ...
    public void simplifyScopedStoragePathTest() {
        ...
        assertThat(FileUtils.simplifyScopedStoragePath("/storage/emulated/0/Android/data/ar.gob.buenosaires.barelevamiento/files/layers"), is("/sdcard/Android/data/ar.gob.buenosaires.barelevamiento/files/layers"));
        assertThat(FileUtils.simplifyScopedStoragePath("/storage/emulated/0/Android/data/ar.gob.buenosaires.barelevamiento/files/layers/countries/countries-raster.mbtiles"), is("/sdcard/Android/data/ar.gob.buenosaires.barelevamiento/files/layers/countries/countries-raster.mbtiles"));
    }
}
