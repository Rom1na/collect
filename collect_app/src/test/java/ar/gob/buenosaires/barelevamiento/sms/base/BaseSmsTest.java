package ar.gob.buenosaires.barelevamiento.sms.base;
...
import static ar.gob.buenosaires.barelevamiento.tasks.sms.SmsSubmissionManager.KEY_SUBMISSION;
...
public abstract class BaseSmsTest {
    ...
    public void setupSmsSubmissionManagerData() {
        ...
        for (SmsSubmission smsSubmission : SampleData.generateModels()) {
            ...
            editor.putString(SmsSubmissionManager.KEY_SUBMISSION + smsSubmission.getInstanceId(), data);
            editor.commit();
        }
    }
