...
import ar.gob.buenosaires.barelevamiento.openrosa.support.MockWebServerRule;
...
import ar.gob.buenosaires.barelevamiento.openrosa.support.MockWebServerHelper;
import ar.gob.buenosaires.barelevamiento.openrosa.support.MockWebServerRule;
...
import static ar.gob.buenosaires.barelevamiento.openrosa.support.MockWebServerHelper.buildRequest;
...
public abstract class OpenRosaServerClientProviderTest {
    ...
    public void withCredentials_whenBasicChallengeReceived_whenHttps_retriesWithCredentials() throws Exception {
        ...
        client.makeRequest(MockWebServerHelper.buildRequest(httpsMockWebServer, ""), new Date());
    ...
    public void withCredentials_onceBasicChallenged_whenHttps_proactivelySendsCredentials() throws Exception {
        ...
        OpenRosaServerClient client = subject.get("https", "Android", new HttpCredentials("user", "pass"));
        client.makeRequest(MockWebServerHelper.buildRequest(httpsMockWebServer, ""), new Date());
        client.makeRequest(MockWebServerHelper.buildRequest(httpsMockWebServer, "/different"), new Date());
