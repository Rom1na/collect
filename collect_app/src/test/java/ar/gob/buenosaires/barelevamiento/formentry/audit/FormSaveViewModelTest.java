...
import static ar.gob.buenosaires.barelevamiento.formentry.saving.FormSaveViewModel.SaveResult.State.CHANGE_REASON_REQUIRED;
import static ar.gob.buenosaires.barelevamiento.formentry.saving.FormSaveViewModel.SaveResult.State.CONSTRAINT_ERROR;
import static ar.gob.buenosaires.barelevamiento.formentry.saving.FormSaveViewModel.SaveResult.State.FINALIZE_ERROR;
import static ar.gob.buenosaires.barelevamiento.formentry.saving.FormSaveViewModel.SaveResult.State.SAVED;
import static ar.gob.buenosaires.barelevamiento.formentry.saving.FormSaveViewModel.SaveResult.State.SAVE_ERROR;
import static ar.gob.buenosaires.barelevamiento.formentry.saving.FormSaveViewModel.SaveResult.State.SAVING;
